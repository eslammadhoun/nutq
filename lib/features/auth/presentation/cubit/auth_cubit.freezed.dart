...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthInitial value)?  initial,TResult Function( AuthLoading value)?  loading,TResult Function( AuthSuccess value)?  success,TResult Function( AuthFieldErrors value)?  fieldErrors,TResult Function( AuthFailure value)?  failure,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AuthInitial() when initial != null:
return initial(_that);case AuthLoading() when loading != null:
return loading(_that);case AuthSuccess() when success != null:
return success(_that);case AuthFieldErrors() when fieldErrors != null:
return fieldErrors(_that);case AuthFailure() when failure != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthInitial value)  initial,required TResult Function( AuthLoading value)  loading,required TResult Function( AuthSuccess value)  success,required TResult Function( AuthFieldErrors value)  fieldErrors,required TResult Function( AuthFailure value)  failure,}){
final _that = this;
switch (_that) {
case AuthInitial():
return initial(_that);case AuthLoading():
return loading(_that);case AuthSuccess():
return success(_that);case AuthFieldErrors():
return fieldErrors(_that);case AuthFailure():
return failure(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthInitial value)?  initial,TResult? Function( AuthLoading value)?  loading,TResult? Function( AuthSuccess value)?  success,TResult? Function( AuthFieldErrors value)?  fieldErrors,TResult? Function( AuthFailure value)?  failure,}){
final _that = this;
switch (_that) {
case AuthInitial() when initial != null:
return initial(_that);case AuthLoading() when loading != null:
...
class AuthFieldErrors implements AuthState {
  const AuthFieldErrors(final  Map<String, String> errors): _errors = errors;
...
$AuthFieldErrorsCopyWith<AuthFieldErrors> get copyWith => _$AuthFieldErrorsCopyWithImpl<AuthFieldErrors>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthFieldErrors&&const DeepCollectionEquality().equals(other._errors, _errors));
}
...
@override
String toString() {
  return 'AuthState.fieldErrors(errors: $errors)';
}
...
/// @nodoc
abstract mixin class $AuthFieldErrorsCopyWith<$Res> implements $AuthStateCopyWith<$Res> {
  factory $AuthFieldErrorsCopyWith(AuthFieldErrors value, $Res Function(AuthFieldErrors) _then) = _$AuthFieldErrorsCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$AuthFieldErrorsCopyWithImpl<$Res>
    implements $AuthFieldErrorsCopyWith<$Res> {
  _$AuthFieldErrorsCopyWithImpl(this._self, this._then);

  final AuthFieldErrors _self;
  final $Res Function(AuthFieldErrors) _then;

/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? errors = null,}) {
  return _then(AuthFieldErrors(
