...
mixin _$JobDetailEntity {
 ...
 String get id; String get status; String get sourceType; String get language; DateTime get createdAt; DateTime get updatedAt; String? get errorCode; String? get errorDetail; UploadSlot? get uploadSlot; Transcript? get transcript; Summary? get summary;
...
@override
String toString() {
  return 'JobDetailEntity(id: $id, status: $status, sourceType: $sourceType, language: $language, createdAt: $createdAt, updatedAt: $updatedAt, errorCode: $errorCode, errorDetail: $errorDetail, uploadSlot: $uploadSlot, transcript: $transcript, summary: $summary)';
}
...
@useResult
$Res call({
 String id, String status, String sourceType, String language, DateTime createdAt, DateTime updatedAt, String? errorCode, String? errorDetail, UploadSlot? uploadSlot, Transcript? transcript, Summary? summary
});
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String status,  String sourceType,  String language,  DateTime createdAt,  DateTime updatedAt,  String? errorCode,  String? errorDetail,  UploadSlot? uploadSlot,  Transcript? transcript,  Summary? summary)  $default,) {final _that = this;
switch (_that) {
case _JobDetailEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String status,  String sourceType,  String language,  DateTime createdAt,  DateTime updatedAt,  String? errorCode,  String? errorDetail,  UploadSlot? uploadSlot,  Transcript? transcript,  Summary? summary)?  $default,) {final _that = this;
switch (_that) {
case _JobDetailEntity() when $default != null:
return $default(_that.id,_that.status,_that.sourceType,_that.language,_that.createdAt,_that.updatedAt,_that.errorCode,_that.errorDetail,_that.uploadSlot,_that.transcript,_that.summary);case _:
  return null;
...
class _JobDetailEntity implements JobDetailEntity {
  const _JobDetailEntity({required this.id, required this.status, required this.sourceType, required this.language, required this.createdAt, required this.updatedAt, this.errorCode, this.errorDetail, this.uploadSlot, this.transcript, this.summary});
